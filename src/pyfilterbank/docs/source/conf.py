...
project = 'PyFilterbank'
copyright = '2014, Siegfried Gündert'
...
latex_documents = [
  ('index', 'PyFilterbank.tex', 'PyFilterbank Documentation',
...
man_pages = [
    ('index', 'pyfilterbank', 'PyFilterbank Documentation',
     ['Siegfried Gündert'], 1)
]
...
texinfo_documents = [
  ('index', 'PyFilterbank', 'PyFilterbank Documentation',
   'Siegfried Gündert', 'PyFilterbank', 'One line description of project.',
   'Miscellaneous'),
]
